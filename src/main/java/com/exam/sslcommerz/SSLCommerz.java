package com.exam.sslcommerz;



import com.exam.sslcommerz.Utility.ParameterBuilder;
import com.exam.sslcommerz.parametermappings.SSLCommerzInitResponse;
...
import com.exam.sslcommerz.Utility.Util;
import com.exam.sslcommerz.parametermappings.SSLCommerzValidatorResponse;
...
public class SSLCommerz {
    ...
    //Store id =bdsof60729f7f07943
    //store password =bdsof60729f7f07943@ssl
    ...
    public String initiateTransaction(Map<String, String> postData, boolean isGetGatewayList) throws Exception {
        ...
        postData.put("bdsof60729f7f07943", this.storeId);   //my ssl account stored id
        postData.put("bdsof60729f7f07943@ssl", this.storePass); //my ssl  account password
